...
const Contact = ({ lang }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setConfirm("loading");
    const scriptUrl =
      "https://script.google.com/macros/s/AKfycby5bQpyQnJEjOGqjMGJcNopE_4SRmI3lswBK9OWESehpEUTWRM/exec";
          ...
          <div className={style.containerContacto}>
            {lang === "ES" && (
              <Infobox
                subtitle={"Charlemos!"}
                text={
                  "Me encantaría hablar con vos.<br />Desde este formulario la página me envía un email directamente a mi correo.<br /> Podés ponerlo a prueba escribiéndome un mensajito para que te responda. "
                }
              />
            )}
            {lang === "EN" && (
